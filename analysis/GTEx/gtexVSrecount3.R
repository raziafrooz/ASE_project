...
cc_fill <-scale_fill_manual(values=met.brewer("Isfahan1"))
cc_color <-scale_color_manual(values=met.brewer("Isfahan1"))
...
plotFile<-"/dcs07/hansen/data/recount_ASE/data/gtexVSrecount.csv.gz"
